...
public class ControllerSupplier {
    ...
    void initialize() {
        ...
        try {
            ...
            @SuppressWarnings("SqlResolve") ResultSet rs = stmt.executeQuery("select " +
                    "SupplierContactId, " +
                    "SupConFirstName, " +
                    "SupConLastName, " +
                    "SupConCompany, " +
        ...
        cbSupCon.getSelectionModel().selectedItemProperty().addListener((observableValue, oldValue, newValue) -> {
